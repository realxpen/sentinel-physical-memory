...
try {
  ...
  expect(main.includes('current-memory-section'), 'verified physical context must remain accessible through the canonical current-object Memory surface')
  expect(main.includes('spatial-object-drawer'), 'current physical objects must retain rich evidence/history detail after verification')
