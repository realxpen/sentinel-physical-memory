...
export class NebiusNemotronAdapter implements ModelAdapter, ReasoningModelAdapter, ActionPlanningModelAdapter, VerificationModelAdapter {
  ...
  private systemPrompt(role: ModelInferenceRequest['role']): string {
    return [
      ...
      'For this environmental-memory MVP, people are transient rather than durable spatial objects. Do not emit category="person" or person/occupant/worker objects. Do not infer a person from distant silhouettes, reflections, foliage, signage, furniture, or outdoor background shapes. Persist the environment, not human identity or occupancy.',
